...
void procesarComando(String cmd) {
  ...
  if (checksumCalc != checksumRecibido) return;
  ...
  else if (codigo == 5) periodoTempHum = params.toInt();
  else if (codigo == 6) periodoDist = params.toInt();
  else if (codigo == 7) modoRastreo = true;
  else if (codigo == 8) {
  ...
  else if (codigo == 10) mediasEnSatelite = true;
  else if (codigo == 11) mediasEnSatelite = false;
  else if (codigo == 12) {
